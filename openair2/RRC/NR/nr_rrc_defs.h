...
typedef struct gNB_RRC_UE_s {
  ...
  /* CPE UE handover support */
  uint64_t imsi;       /* populated from NGAP Initial UE Message / SUPI when available */
  uint8_t  is_cpe_ue;  /* 1 = this context was injected for a CPE_UE (no RACH) */
