...
typedef struct nr_handover_context_s {
  ...
  int64_t trigger_us;
  int64_t f1_setup_req_us;
  int64_t f1_setup_resp_us;
  int64_t rrc_reconf_send_us;
  int64_t rrc_reconf_complete_us;
  int64_t source_release_cmd_us;
...
/* E2 agent (CHO xApp) entry point: trigger intra-CU F1 HO for the UE
 * identified by RNTI. */
